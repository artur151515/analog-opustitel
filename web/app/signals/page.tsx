...
function SignalsPageContent() {
	...
	const timeframes = symbolsData?.timeframes || [
		"1m",
		"3m",
		"5m",
		"15m",
	...
	const winratePercentage = stats
		? (stats.winrate_last_n * 100).toFixed(1)
		: "0.0";
	const breakEvenPercentage = stats
	...
	return (
		<div className="min-h-screen bg-[#0a0e1a]">
			...
			<main className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-12">
				...
				<div className="mb-8">
					<div
						className="tradingview-widget-container p-0 overflow-hidden"
						style={{ height: "500px" }}
					>
						<TradingViewWidget
						...
						{signalError && (
							<div className="card border-danger-200 bg-danger-50">
								<p className="text-danger-800">
									{translate({
										ru: "Не удалось загрузить данные сигнала. Попробуйте ещё раз.",
										en: "Failed to load signal data. Please try again.",
									})}
								</p>
							</div>
						)}
