...
const POCKET_OPTION_URL = 'https://pocket-option.su'
        ...
        <div className="bg-[#0f1419] rounded-xl border border-gray-800 p-8">
          ...
          <form onSubmit={handleRegister}>
            ...
            <div className="space-y-4">
              ...
              >
                {loading ? (language === 'ru' ? 'Загрузка...' : 'Loading...') : (language === 'ru' ? 'Зарегистрироваться' : 'Register')}
              </button>
            </div>
          </form>
          ...
          <div className="mt-6 p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
            ...
            >
              {language === 'ru' ? 'Перейти на PocketOption' : 'Go to PocketOption'}
            </a>
          </div>
        </div>
