			...
			<div className="max-w-5xl mx-auto px-6 py-20">
				<div className="text-center mb-16">
					...
					<p className="text-2xl text-slate-300 max-w-3xl mx-auto">
						{translate({
							ru: "Чтобы начать получать торговые сигналы, пополните ваш аккаунт.",
							en: "To start receiving trading signals, please top up your account.",
						})}
					</p>
				</div>
				...
				<div className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 backdrop-blur-sm rounded-3xl border border-blue-500/30 p-12 mb-12 shadow-2xl">
					<h2 className="text-3xl font-bold text-white mb-8 text-center">
						{translate({
							ru: "Уровни доступа к сигналам",
							en: "Signal Access Levels",
						})}
					</h2>
							...
							<div className="text-center">
								...
								<ul className="text-slate-300 space-y-2 text-sm">
									...
									<li>
										•{" "}
										{translate({
											ru: "Основные валютные пары",
											en: "Major currency pairs",
										})}
									</li>
									<li>
										•{" "}
										{translate({
											ru: "Стандартные таймфреймы",
											en: "Standard timeframes",
										})}
									</li>
								</ul>
							</div>
							...
							<div className="text-center">
								...
								<ul className="text-slate-200 space-y-2 text-sm">
									<li>
										•{" "}
										{translate({
											ru: "Безлимит сигналов",
											en: "Unlimited signals",
										})}
									</li>
									<li>
										•{" "}
							...
							<div className="text-center">
								...
								<ul className="text-slate-300 space-y-2 text-sm">
									...
									<li>
										•{" "}
										{translate({
											ru: "Все активы (включая OTC)",
											en: "All assets (including OTC)",
										})}
									</li>
									<li>
										•{" "}
										{translate({
											ru: "Эксклюзивные таймфреймы",
											en: "Exclusive timeframes",
										})}
									</li>
									<li>
										•{" "}
				...
				<div className="text-center space-y-6">
					...
					<p className="text-slate-400 text-sm">
						{translate({
							ru: "После пополнения баланса вы получите доступ к торговым сигналам.",
							en: "After topping up your balance, you will gain access to trading signals.",
						})}
					</p>
				</div>
			</div>
